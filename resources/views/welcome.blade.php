        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            @if (Route::has('login'))
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    @auth
                        <a href="{{ url('/home') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">Bienvenidos Ingresa Aquí</a>
                    @else
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                    ...
                    <img src="https://biotechchile.cl/biotech_ecommerce/static/src/img/desktop/CATEGORIA-16-HIGIENE-8.png" style="width: 60px; height: 60px;">
            </div>
                </div>
